...
const RightSidebar = () => {
  return (
    <section className="background-light900_dark200 right-0 top-0 light-border sticky flex  h-screen flex-col overflow-y-auto border-l p-6 pt-36 shadow-light-300 dark:shadow-none max-xl:hidden lg:w-[350px] custom-scrollbar">
      <div>
